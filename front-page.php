<?php
/**
 * La plantilla de la página de presentación (Front Page)
 *
 * @package System
 */
...
// El ancho inicial del main se ajusta dinámicamente mediante JS si los sidebars están activos
...
<main id="primary" class="site-main <?php echo esc_attr( $main_classes ); ?>">
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        <header class="entry-header text-center mb-4">
            <h2 style="font-family: 'Orbitron', sans-serif; letter-spacing: 2px; font-size: 1.2rem; color: var(--sys-text-dim);"><?php esc_html_e( '// ACCESO RESTRINGIDO //', 'system' ); ?></h2>
        </header>
        ...
        <div class="entry-content">
            ...
            if ( is_user_logged_in() ) {
                ...
                echo '<p style="color: var(--sys-primary); letter-spacing: 1px;" class="mb-3">' . sprintf( esc_html__( 'AUTORIZADO: %s', 'system' ), esc_html( strtoupper($current_user->display_name) ) ) . '</p>';
